...
const TEST_MNEMONICS = [
  ...
  'glance indicate silent mesh radio vivid glue fiscal journey orange must print',
];

const sharedKey = '37e3984a41b34eaac002c140b28e5d080f388098a51d34237f33e84d14b9e491';
...
const setupTestWallets = async () => {
  ...
  leaves = notesPrep.map((keyIndex) => {
    const note = new Note(
      Lepton.decodeAddress(testWallets[0].getAddress(0)),
  ...
  leaves2 = notesPrep2.map((keyIndex) => {
    const note = new Note(
      Lepton.decodeAddress(testWallets[1].getAddress(0)),
      '1e686e7506b0f4f21d6991b4cb58d39e77c31ed0577a986750c8dce8804af5b9',
      'ffff',
      '7f4925cdf66ddf5b88016df1fe915e68eff8f192',
    );
